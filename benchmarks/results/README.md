...
| `cpu-m4-q4k-sme2/` | Apple M4 negative full-decode gate | Preserves real Q4_K values through an affine SME2 transform and wins 1.132x-1.158x over custom raw NEON on two full Qwen 3B FFN tensors, but loses 0.857x to llama x8 in repeated `tg128`; the opt-in integration stays disabled. |
