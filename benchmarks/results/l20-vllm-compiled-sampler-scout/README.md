...
- Metadata has seed tensor: `False`
- Metadata has position tensor: `False`
- Sampler passes RNG state: `False`
- TopKTopP ops accepts RNG state: `True`
- Stateful sampler ready: `False`
...
| P0 | `False` | build a state-preserving compiled sampler prototype |
| P0 | `False` | measure CUDA graph membership before claiming speed |
