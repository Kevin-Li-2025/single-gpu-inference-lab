...
| CPU vs L20 break-even | Boundary table / pending same-model runner | `scripts/build_cpu_l20_break_even.py`, `scripts/run_vllm_l20_qwen25_coder_0p5b_break_even.sh`, `benchmarks/results/cpu-l20-break-even/qwen-family-p512-o32-o128-v1/`, `benchmarks/results/cpu-l20-break-even/qwen25-coder-0p5b-identical-model-pending/`, `docs/cpu-small-model-boundary.md` | First Qwen-family p512 boundary table. Real M4 CPU Qwen2.5-Coder Q4_K_M reports 0.568 serial req/s for p512/o32 and 0.351 serial req/s for p512/o128. Checked-in L20 Qwen3-0.6B FlashInfer serving rows span 7.45x-74.63x serial-M4 request throughput equivalent. This is family-level evidence, not identical-model proof; the same-model Qwen2.5-Coder-0.5B L20 runner is checked in, and the next proof is running it on L20 to produce p512/o32 and p512/o128 serving summaries. |
...
CPU tiny-transformer cost/boundary control ->
